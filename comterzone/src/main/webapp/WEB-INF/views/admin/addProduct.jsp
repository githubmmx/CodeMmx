                        ...
                        <ul>
                            <li>
                                <div class="w-100 d-flex aPBRow">
                                    <div class="aPBCol1">
                                        <label for="" class="font-weight-bold">카테고리<span class="text-primary">(필수)</span>
                                        </label>
                                    </div>
                                    <div class="aPBCol2">
                                        <label for="category1">카테고리1</label>
                                        <select name="category1" id="" list="c1Data">
                                            <datalist id="c1Data">
                            ...
                            <li>
                                <div class="w-100 d-flex aPBRow">
                                    <div class="aPBCol1">
                                        <label for="" class="font-weight-bold">상품명<span class="text-primary">(필수)</span>
                                        </label>
                                    </div>
                                    <div class="aPBCol2">
                                        <input id="" class="input-L" type="text" placeholder="예시) 라이젠 CPU">
                                        <label class="" for="">[<strong class="text-primary">0</strong>/250]</label>
                                    </div>
                            ...
                            <li>
                                <div class="w-100 d-flex aPBRow">
                                    <div class="aPBCol1">
                                        <label for="" class="font-weight-bold">판매가<span class="text-primary">(필수)</span>
                                        </label>
                                    </div>
                                    <div class="aPBCol2">
                            ...
                            <li>
                                <div class="w-100 d-flex aPBRow">
                                    <div class="aPBCol1">
                                        <label for="" class="font-weight-bold">자체 상품코드<span class="text-primary"></span>
                                        </label>
                                    </div>
                                    <div class="aPBCol2">
                                        <input id="" class="input-M" type="number" placeholder="">
                                        <a href=""><span style="">중복확인</span></a>
                                        <label class="" for="">[<strong class="text-primary">0</strong>/40]</label>
                                    </div>
                            ...
                            <li>
                                <div class="w-100 d-flex aPBRow">
                                    <div class="aPBCol1" style="height: auto;">
                                        <label for="" class="font-weight-bold">상품 상세설명<span class="text-primary"></span>
                                        </label>
                                    </div>
                            ...
                            <li>
                                <div class="w-100 d-flex aPBRow">
                                    <div class="aPBCol1" style="height: auto;">
                                        <label for="" class="font-weight-bold">이미지<span class="text-primary"></span>
                                        </label>
                                    </div>
                                    <div class="aPBCol2" style="height: auto;">
                                        <div style="padding-right: 15px;">
                                            <span>대표이미지</span>
                                            <div style="width: 268px; height: 268px;border: 1px solid #DEDEDE; position: relative;">
                                                <input type="file" style="width: 100%;height: 100%;opacity: 0;">
                                                <i style="pointer-events: none;position: absolute;left: 134px;top: 134px;transform: translateX(-50%) translateY(-50%);" 
                                                class="fas fa-plus"></i>
                                            </div>
                                            <span class="recom-sz">- 권장 사이즈 : 500px * 500px</span>
                                        </div>
                                        <div style="width: 741.33px; height:350.67px; border-left: 1px solid #DEDEDE; padding-left: 15px;">
                                            <span style="display: block;margin-bottom: 10px;">추가 이미지[<strong class="text-primary">1</strong>/20]</span>
                                            <div style="width: 100px; height: 100px;border: 1px solid #DEDEDE; position: relative;">
                                                <input type="file" style="width: 100%;height: 100%;opacity: 0;">
                                                <i style="pointer-events: none; position: absolute;left: 50px;top: 50px;transform: translateX(-50%) translateY(-50%);" 
                                                class="fas fa-plus"></i>
                                            </div>
                                            <span style="display: block;" class="recom-sz">- 권장이미지 : 500px * 500px / 1M 이하 / gif, png, jpg(jpeg) / 20개까지 추가 가능
                                            </span>
                                        </div>
                                    </div>
