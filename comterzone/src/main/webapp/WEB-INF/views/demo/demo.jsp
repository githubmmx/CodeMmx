...
<section id="content">
	...
	<form id="devFrm" method="post">
			...
			<div class="list-group">
				...
				onclick="demo('${path}/demo/basicParam.do');">
				기본파라미터처리하기</button>
				<button type="button" 
				class="list-group-item list-group-item-action"
				onclick="demo('${path}/demo/requestParam.do');">
				@RequestParam으로 처리하기</button>
				<button type="button" 
				class="list-group-item list-group-item-action"
				onclick="demo('${path}/demo/requestMap.do');">
				Map으로 처리하기</button>
				<button type="button" 
				class="list-group-item list-group-item-action"
				onclick="demo('${path}/demo/requestCommand.do');">
				Command(vo)으로 처리하기</button>
			</div>
		</form>
	</div>
		<script>
