package com.comterzone.shop.member.controller;
...
import com.comterzone.shop.member.model.service.MemberService;
...
public class MemberController {
	...
	public String checkIdJonView(String userId,Model model) {
		Member m=service.selectMember(userId);
		boolean flag=m!=null?false:true;
